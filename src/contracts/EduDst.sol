...
/**
 * @title EduDst
 * @dev EduDst is an abstract contract that inherits from EduBase and
 ...
 */
abstract contract EduDst is EduBase {
    ////////////////////////////////////////////////////////
    ////////////////////// ERRORS //////////////////////////
    ////////////////////////////////////////////////////////
     ...
     */
    function execute(
        IEdu.ExecutionDetails calldata executionDetails_,
        IEdu.MessageDetails calldata messageDetails_
    ) external payable override {
    ...
    function _execute(
        ...
        IEdu.MessageDetails memory messageDetails_
    ) internal {
