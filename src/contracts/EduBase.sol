...
import "./EduConfig.sol";

/**
 * @title EduBase
 * @notice A contract that is responsible for common storage for src and dest contracts, governance
 * setters and inherits EduConfig
 */
abstract contract EduBase is EduConfig, AccessControlExtended {
    // Version string for this Edu instance
    bytes32 public immutable version;
    // ChainSlug for this deployed Edu instance
    uint32 public immutable chainSlug;
    // Counter for messages going outbound from current chain
    uint64 public globalMessageCount;

    /**
     * @dev constructs a new Edu contract instance.
     ...
     * remove the fees from executionManager first, and then upgrade address at Edu.
     */
