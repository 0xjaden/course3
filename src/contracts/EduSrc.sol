...
/**
 * @title EduSrc
 * @dev The EduSrc contract inherits from EduBase and handles all the operations that
 ...
 */
abstract contract EduSrc is EduBase {
    ////////////////////////////////////////////////////////
    ////////////////////// ERRORS //////////////////////////
    ////////////////////////////////////////////////////////
    ...
    function outbound(
        ...
        IEdu.Fees memory fees = _validateAndSendFees(
            minMsgGasLimit_,
        ...
        IEdu.MessageDetails memory messageDetails = IEdu.MessageDetails({
            msgId: msgId,
    ...
    function _validateAndSendFees(
        ...
        uint32 siblingChainSlug_
    ) internal returns (IEdu.Fees memory fees) {
